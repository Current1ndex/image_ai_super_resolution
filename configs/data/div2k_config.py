...
def get_div2k_config():
    ...
    parser.add_argument('--data_train_image_path', type=str, default='DIV2K_train_LR_bicubic/X2/')
    parser.add_argument('--data_train_label_path', type=str, default='DIV2K_train_HR/')
    parser.add_argument('--data_valid_image_path', type=str, default='DIV2K_valid_LR_bicubic/X2/')
